...
static void* iterate_import(uint8_t*/*IMAGE_THUNK_DATA*/ iant, uint32_t vaddr) {
  SymbolChain3* e = InitialImport;
  SymbolChain3* s1;
...
void add_import() {
  ...
  SectionContainer* idata_sec_con =
    add_coff_section(".idata", import_vaddr, Confp->import_directory_len, import_data_begin);
