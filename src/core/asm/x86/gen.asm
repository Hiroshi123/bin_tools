	...
	global _mod11_store
	;; fetch displacement
	global __fetch_displacement_by_mod
...
__fetch_displacement_by_mod:
	
	push rbp
	;; check override segment
	mov byte al,[_context._override]
	cmp al,0xff
	jne __fetch_displacement_by_mod._no_override
...
._no_override:
	...
	cmp al,0xff
	je __fetch_displacement_by_mod.sib_displacement
	;; RIP relative offset check
	mov byte al,[_context._rip_rel]
	cmp al,0xff
	jne __fetch_displacement_by_mod._no_offset
	;; if processor mode is x64 then it is rip offset
	cmp byte [_processor],0x64
	je __fetch_displacement_by_mod._x64
._x32:
	call _fetch_absolute_offset
	jmp __fetch_displacement_by_mod.end
._x64:
